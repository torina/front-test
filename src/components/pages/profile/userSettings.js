import { Grid, Box, Typography, TextField, MenuItem, Select, InputAdornment, Avatar } from "@mui/material";
...
const UserSettings = ({ values, setValues, handleChange, preview, handleFileUpload, locationAddress, handleChangeLocation, editable, role, previewCrop }) => {
      ...
      <Grid item xs={12} md={7}>
        ...
        {role === "Donor" && (
          <Box sx={{ pt: "1.5rem" }}>
            ...
            <SimpleSelect
              ...
              handleChange={handleChange("donorType")}
              array={donorTypes}
              readOnly={!editable}
            />
          </Box>
        ...
        <Box sx={{ pt: "1.5rem" }}>
          ...
          <TextInput
            ...
            handleChange={handleChangeLocation("street")}
